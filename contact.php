...
<body>
  ...
  <div id="wrap" class="boxed">
   ...
   <div class="style-2 home s-2 bottom-3">
     <div class="container clearfix" style="background-color: #FF0080;">
        
        <div class="twelve columns bottom-3"  style="min-height:260px;">
        <p>Address : Nipani</p>
        <p>Phone : 9071295107</p>
        <p>Phone : 9148619932</p>
        <p>Email : info@parkingportal.com</p>
